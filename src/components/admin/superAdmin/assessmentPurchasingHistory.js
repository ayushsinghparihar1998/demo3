...
class AssessmentPurchasingHistory extends Component {   
    render() {
        return ( 
                    ...
                    <div className="profile_layout ListenerTests myAssesstestMain pt-4 pb-5">   
                        <div className="chatsearch w-100">
                            <div className="myAssesstest"> 
                                <div className="fs22 fw600 col10 mt-4 mb-4 pl-4">Assessment Test Purchasing History
                                </div> 
                                        ...
                                        <Table bordered size="lg">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>30</td>
                                                    <td>
                                                        <div className="d-flex elpCategory justify-content-center">
...
export default AssessmentPurchasingHistory; 
