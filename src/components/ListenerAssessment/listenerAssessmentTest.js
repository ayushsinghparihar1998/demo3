...
class ListenerAssessmentTest extends Component {  
                    ...
                    <div className="profile_layout ListenerTests myAssesstestMain pt-4 pb-5">   
                        <div className="chatsearch w-100">
                            <div className="myAssesstest"> 
                                <div className="fs22 fw600 col10 mt-4 mb-4 pl-4">Member’s Assessment Test</div> 
...
export default ListenerAssessmentTest;  
