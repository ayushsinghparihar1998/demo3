            ...
            <Container>
                <Row>
                    <Col md={6}> 
                        ...
                        <div className="fs55 fw700 col9">40,997,916</div> 
                        <div className="col3 fs44 fw600">Conversations</div>
                    ...
                    <Col md={6}>
                        ...
                        <div className="fs55 fw700 col9">180</div> 
                        <div className="col3 fs44 fw600">Professional Therapists</div>
