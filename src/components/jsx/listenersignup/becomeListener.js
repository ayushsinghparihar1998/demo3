        ...
        <div className="becomeListener">
          <Container>
            <div className="listener_layout mt-4 mb-4">
              <Row>
                <Col md={8}>
                  <div className="col10 fs40 fw600 mb-1 mt-4 pt-2">Become a Listener</div>
                  <div className="fw300 fs20 col14">Welcome. We’re happy to have you!</div>
                  <div className="fw300 fs15 col28 pt-2">We are building a world-class listening service made up of compassionate,
                  caring individuals like you. Thank you for offering to lend an ear to those in
                  need of support.
                            </div>
                  <div className="fw500 fs20 col29 pt-3">How does it work?</div>
                  <div className="fw300 fs15 col28 pt-2">Getting started as an active listener is easy and rewarding in many ways.
                  You’re in complete control over your displayed availability, so you can listen
