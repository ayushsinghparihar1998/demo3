...
import { actionListnerSignup, actionGetQuestion } from '../../../common/redux/actions';
...
class Listenersignup extends Component {
            ...
            question: [
                {
                    ...
                    list: [{ active: false, name: 'Answer 11' },
                ...
                },
                {
                    ...
                    list: [{ active: false, name: 'Answer 22' },
    ...
    handleSubmit = () => {
        if (this.isValid()) {
            ...
            this.props.actionListnerSignup(data).then((result) => {
                    ...
                    <Container>
                        <div className="layout_box mt-5 mb-4">
                            ...
                            <div className="col14 fs20 fw300 mb-4 pb-3">
                                Sign up to be a <span className="fw500">EatLoveNPray</span> Listener and offer support to guests and members via online chats.
                    </div>
                                    ...
                                    <Row>
                                        <Col md={12}>
                                            <Form.Group>
                                                ...
                                                <div className="fs13 fw300 col27 pb-2">An email will be sent to verify your account. We won’t share your email address with anyone.</div>
                                                ...
                                                <div className="fs13 fw300 col27 pt-2 pb-2">If you already have a member account, you can use the same email and password for easy switching.</div>
                                            </Form.Group>
                                        </Col>
                                        ...
                                        <Col md={12}>
                                            <Form.Group>
                                                <Form.Label className="fs20 fw600 col14">Add Categor</Form.Label>
                                                <Form.Control
                                                    type="category"
                                        ...
                                        <Col md={12}>
                                            ...
                                            <div className="fs13 fw300 col27 pb-2">Applicants must be at least 18 years old or 15 years old with parental consent.</div>
                                        </Col>
                                    ...
                                    <Form.Control
                                        ...
                                        <Col md={12}>
                                            ...
                                            <div className="fs18 col14 mt-3 mb-3 fw300">
                                                I am not in crisis, homicidal, sucidal or abusing anyone, and i agree to the Eat Luv N Pray <span className="fw500 pointer">Terms of service & Privacy Policy</span>
                                            </div>
                                            <Button onSubmit={this.handleSubmit}
                                                onClick={this.handleSubmit} className="btnTyp5 mt-3">
                                                continue
                                </Button>
                                        </Col>
                                    </Row>
                                                        ...
                                                        return (
                                                            <div>
                                                                <div className="col11 fs20 fw500">
                                                                    <span className="fw600 col29">{item.name}</span> Lorem ipsum dolor sit amet, consectetur adipiscing elit?
                                                    </div>
                            ...
                            <div className="fs18 fw300 pt-5 col14">Already have an account?
                    <span className="fw500 pointer pl-1"><Link to={`/login`} >Login here</Link></span></div>
...
export default connect(
    null,
    { actionListnerSignup, actionGetQuestion }
)(Listenersignup);
