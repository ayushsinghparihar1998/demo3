    ...
    this.props
      ...
      .then((result) => {
        if (result && result.data && result.data.status === "success") {
          ...
          setLocalStorage("userInfo", result.data.data.u_accesstoken);
          setLocalStorage("u_email", result.data.data.u_email);
          setLocalStorage("u_id", result.data.data.u_id);
          setLocalStorage("u_role_id", result.data.data.u_role_id);
        }
      })
      .catch((error) => {
        console.log(error);
