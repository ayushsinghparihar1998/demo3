                ...
                <Row>
                    <Col md={12} lg={12} className="m-auto">
                        ...
                        <div className="col14 fw300 w-100"> 
                            ...
                            How we do it – By Listening and properly understanding the help or problem areas of our client.
Understanding the root cause and not just treating the symptoms: Our primary objective is to diagnose
the root cause so that the client is aware of what triggered the illness and we can plan the disease
management protocol accordingly.</div>

<div className="fw400 col14 pb-2">
Many diseases just don’t happen immediately, they happen over
prolonged period of time. Only when we spend time diagnosing and looking back at their lifestyle, can
we find the possible source of the disease. It could either be a constantly low level of immunity or an
emotional scar or poor nutrition. We need to start addressing the root causes of a disease to repair our
