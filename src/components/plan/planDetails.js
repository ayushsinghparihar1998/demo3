              ...
              <Row>
                ...
                <Col md={7}> 
                  <div class="elpVideoblog">   
                     ...
                     <Image src={Splan} alt="Plan" className="w-100 iconVideomain" />  
                      <div>
                        <Image src={VideoIcon} className="iconVideo" />
                          <div class="">
                            <iframe frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="YouTube video player" width="100%" height="400" src="https://www.youtube.com/embed/?autoplay&amp;enablejsapi=1&amp;origin=http%3A%2F%2Flocalhost%3A3000&amp;widgetid=1" id="widget2">
                            </iframe> 
