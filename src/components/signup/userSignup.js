...
class ProfessionalSignup extends Component {
    ...
    handleSubmit = () => {
        if (this.isValid()) {
            ...
            this.props.actionUserSignup(data).then((result) => {
            ...
            <div>
                <div className="layout_box mt-3 mb-4">
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <div className="fs13 fw300 mt-2 col27">Please make sure you enter the correct date. You will be unable to change this later.</div>
                        </Col>
