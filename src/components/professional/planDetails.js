                            ...
                            <Row>
                                <Col md={5}>
                                    <div className="subscriptionDetails pr-3">  
                                        ...
                                        <div className="fs15 fw400 col14 mt-3 mb-4 pb-1">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. </div> 

                                        <Form>
                                        <Form.Group controlId="formBasicPassword"> 
                                            <Form.Control type="text" className="inputTyp2" placeholder="Enter Email Address" />  
                                        </Form.Group> 
                                        <Button variant="primary" className="btnTyp5 mt-3" type="submit">  
                                            CONTINUE 
                                        </Button>
                                        </Form>
                                    </div>
                            ...
                            <Row> 
                                <Col md={5}> 
                                    <div className="subscriptionDetails p-3">         
                                        ...
                                        <div className="fs15 fw400 col14 mt-3 mb-2 pb-1">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. </div> 

                                        <Form>
                                        <Button variant="primary" className="btnTyp5 mt-3" type="submit">  
                                            Get A Quote  
                                        </Button>
                                        <a className="ml-3">LEARN MORE <Image src={Arrowright} /></a>   
                                        </Form>
                                    </div>
                                </Col>
                                <Col md={7}>
