                                ...
                                <Row>
                                  ...
                                  {proffDetail.u_lang}
                                                            ...
                                                            <div className="col3 fw500 mt-1 mb-2">
                                                                Keywords:
                                                                <span className="col14 fw400 ml-2">
                                  {this.state.professional_keyword.length !== 0 &&
                                  this.state.professional_keyword.map((obj, i) => {
                                          return obj.pk_keyword
                                      }
                                      // (item, index) => {
                                      //   return (
                                      //     <>
                                      //       {item.pk_keyword}
                                      //       {index + 1 === proffDetail.professional_cat_name.length ? "" : ","}
                                      //       {" "}
                                      //     </>
                                      //   );
                                      // }
                            ...
                            <Modal.Body>
                                <Container>
                                    <div className="layout_box mt-3 mb-4">
                                        <div className="col10 fs30 fw600 mb-4 pb-1">Book a Session</div>
                                        <Form>
