...
class ProfessionalBlogList extends Component {
    ...
    getBlogAll = (offset, count, isTabSwitched) => {
        ELPRxApiService("getblog", {offset, count, category: "'Eat','Luv','Pray'"})
            .then((res) => {
                if (isTabSwitched) {
                    this.setState({
    ...
    onSubscribe = () => {
        ELPRxApiService("subscribe", {email: this.state.email})
            .then((res) => {
                this.setState({email: ""})
            })
            .catch((err) => {
                                            ...
                                            <Row>
                                                ...
                                                {!this.state.showDetails ? (
                                                        <>
                                                            <Col md={7}>
                                                                <Row>
                                                                    {this.state.blogAll.length === 0 ? 'No Data Found' : this.state.blogAll.map((data, i) =>
